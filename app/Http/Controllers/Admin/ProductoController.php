...
class ProductoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'constructivas' => 'nullable|string',
            'tablero' => 'nullable|string',
            'quemador' => 'nullable|string',
        ...
        $producto = Producto::create(array_filter([
            ...
            'constructivas' => $request->constructivas ? $request->constructivas : null,
            'tablero' => $request->tablero ? $request->tablero : null,
            'quemador' => $request->quemador ? $request->quemador : null,
