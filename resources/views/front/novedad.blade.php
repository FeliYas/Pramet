        ...
        <div class="py-15 flex flex-col lg:flex-row gap-30 w-[90%] max-w-[1224px] mx-auto text-black">
            <div class="lg:w-3/4 flex flex-col">
                <div id="novedad-elegida" class="flex flex-col text-black">
                    <p>{{ ucfirst($novedadElegida->epigrafe) }} | {{ $novedadElegida->created_at->format('d/m/Y') }}</p>
                    <h2 class="text-[32px] font-bold">{{ Str::ucfirst($novedadElegida->titulo) }}</h2>
                    <img src="{{ $novedadElegida->path }}" alt="{{ Str::ucfirst($novedadElegida->titulo) }}"
                        class="w-full h-[457px] object-cover mt-2 mb-10">
