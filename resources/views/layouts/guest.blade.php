...
<body class="flex flex-col min-h-screen justify-between bg-white font-scheherazade">
    ...
    <a href="https://wa.me/{{ $whatsapp }}" target="_blank"
        class="fixed bottom-18 right-5 lg:right-15 lg:bottom-25 m-4 z-20 bg-[#00C820] p-3 rounded-full shadow-lg flex items-center justify-center hover:bg-green-600 transition duration-300 ease-in-out">
