                    ...
                    <div v-for="row in data" :key="row.id" class="grid-row">
                        ...
                        <div class="grid-cell grid-actions-cell">
                            <div class="grid-actions">
                                ...
                                <button v-if="caracteristicasRoute"
                                    @click="() => router.get(caracteristicasRoute(row.id))"
                                    class="action-button list-button" title="Características">
                                    <i class="fa-solid fa-list-ul text-2xl mt-1 text-blue-700"></i>
                                </button>
