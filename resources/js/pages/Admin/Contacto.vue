                    ...
                    <div class="relative group">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 45 45"
                                ...
                                stroke-linejoin="round" class="mt-0.5">
                                <path
                                    d="M38.0767 15.8543C36.0694 15.7935 34.2505 14.8341 32.8791 13.5466C32.1316 12.8317 31.5402 11.9694 31.1415 11.0151C30.7426 10.0604 30.5454 9.0339 30.5619 8L24.9732 8V28.8295C24.9732 32.3434 22.8774 34.4183 20.2765 34.4183C19.6506 34.432 19.0283 34.3209 18.4462 34.0909C17.8640 33.8613 17.3338 33.5176 16.8862 33.0798C16.4387 32.6422 16.0833 32.1197 15.8404 31.5426C15.5978 30.9658 15.4727 30.3459 15.4727 29.7202C15.4727 29.0941 15.5978 28.4746 15.8404 27.8978C16.0833 27.3208 16.4387 26.798 16.8862 26.3605C17.3338 25.9229 17.8640 25.5792 18.4462 25.3491C19.0283 25.1193 19.6506 25.0084 20.2765 25.0219C20.7939 25.0264 21.3069 25.1167 21.7948 25.2902L21.7948 19.5985C21.2958 19.49 20.7869 19.4362 20.2765 19.4381C18.2431 19.4392 16.2561 20.0426 14.5660 21.1729C12.8758 22.303 11.5587 23.9091 10.7814 25.7878C10.0039 27.6666 9.8008 29.734 10.1981 31.7275C10.5954 33.7218 11.5748 35.553 13.013 36.9905C14.4509 38.4277 16.2829 39.4065 18.2771 39.8028C20.2711 40.1991 22.3383 39.9952 24.2163 39.2169C26.0949 38.4385 27.7002 37.1209 28.8296 35.4301C29.9593 33.7397 30.5619 31.7522 30.5619 29.7188V18.8324C32.7275 20.3418 35.3149 21.0404 38.0767 21.0868V15.8543Z" />
                            </svg>

                        </div>
                        <label for="tiktok"
                            class="block text-sm font-medium text-gray-700 mb-1 transition-all duration-200 group-focus-within:text-main-color">Tiktok</label>
                        <input type="url" id="tiktok" v-model="form.tiktok"
                            class="pl-10 p-2 bg-white block border border-gray-300 w-full h-10 rounded-lg shadow-sm focus:border-main-color focus:ring focus:ring-main-color focus:ring-opacity-20 transition-all duration-200"
                            placeholder="https://facebook.com/pagina">
                    </div>
